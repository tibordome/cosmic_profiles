...
static PyObject *__pyx_pw_10dens_profs_16dens_profs_algos_1calcMassesCenters(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_masses)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("calcMassesCenters", 1, 6, 6, 1); __PYX_ERR(0, 10, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  2:
        if (likely((values[2] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_idx_cat)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("calcMassesCenters", 1, 6, 6, 2); __PYX_ERR(0, 10, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  3:
        ...
        if (likely((values[4] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_L_BOX)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("calcMassesCenters", 1, 6, 6, 4); __PYX_ERR(0, 10, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  5:
        if (likely((values[5] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_CENTER)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("calcMassesCenters", 1, 6, 6, 5); __PYX_ERR(0, 10, __pyx_L3_error)
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "calcMassesCenters") < 0)) __PYX_ERR(0, 10, __pyx_L3_error)
      }
  ...
  __Pyx_RaiseArgtupleInvalid("calcMassesCenters", 1, 6, 6, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 10, __pyx_L3_error)
  __pyx_L3_error:;
...
static PyObject *__pyx_pf_10dens_profs_16dens_profs_algos_calcMassesCenters(CYTHON_UNUSED PyObject *__pyx_self, CYTHON_UNUSED __Pyx_memviewslice __pyx_v_xyz, CYTHON_UNUSED __Pyx_memviewslice __pyx_v_masses, CYTHON_UNUSED PyObject *__pyx_v_idx_cat, CYTHON_UNUSED int __pyx_v_MIN_NUMBER_PTCS, CYTHON_UNUSED float __pyx_v_L_BOX, CYTHON_UNUSED PyObject *__pyx_v_CENTER) {
  ...
  /* "dens_profs/dens_profs_algos.pyx":28
 *     :return centers, m: centers and masses
 *     :rtype: (N,3) and (N,) floats"""
 *     return             # <<<<<<<<<<<<<<
 * 
 ...
 * 
 */
  __pyx_t_1 = __Pyx_CyFunction_New(&__pyx_mdef_10dens_profs_16dens_profs_algos_1calcMassesCenters, 0, __pyx_n_s_calcMassesCenters, NULL, __pyx_n_s_dens_profs_dens_profs_algos, __pyx_d, ((PyObject *)__pyx_codeobj__20)); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 10, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_calcMassesCenters, __pyx_t_1) < 0) __PYX_ERR(0, 10, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
 ...
 * 
 */
  __pyx_t_1 = __Pyx_CyFunction_New(&__pyx_mdef_10dens_profs_16dens_profs_algos_3calcDensProfsSphDirectBinning, 0, __pyx_n_s_calcDensProfsSphDirectBinning, NULL, __pyx_n_s_dens_profs_dens_profs_algos, __pyx_d, ((PyObject *)__pyx_codeobj__22)); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 32, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
